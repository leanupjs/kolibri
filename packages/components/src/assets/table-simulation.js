...
setTimeout(() => {
	...
	document.querySelector('kol-table#table-4')._pagination = {
		_boundaryCount: 0,
		_on: {
			onClick: console.log,
		},
	};
	document.querySelector('kol-table#table-5')._data = TABLE_PAGED_DATA;
	document.querySelector('kol-table#table-6')._data = TABLE_PAGED_DATA;
}, 5000);
